...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _page.elementAt(
          _currentPage), //khi click vao vi tri thu 1 thi tra ve trong mang vi tri thu 1
  ...
  void _onShowCreateTask() {
    ...
    {
      return Padding(
        padding: MediaQuery.of(context).viewInsets,// đẩy textview lên trên bàn phím
